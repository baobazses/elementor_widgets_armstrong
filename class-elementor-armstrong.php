...
/**
 * Main Elementor Armstrong Class
 *
 * The init class that runs the Elementor Armstrong plugin.
 * Intended To make sure that the plugin's minimum requirements are met.
 *
 * You should only modify the constants to match your plugin's needs.
 *
 * Any custom code should go inside Plugin Class in the widgets-register.php file.
 */
final class Elementor_Armstrong
{
    ...
    {
        load_plugin_textdomain('elementor-armstrong', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
    }
    ...
    {
        deactivate_plugins(plugin_basename(ELEMENTOR_ARMSTRONG));
...
// Instantiate Elementor_Armstrong.
new Elementor_Armstrong();
